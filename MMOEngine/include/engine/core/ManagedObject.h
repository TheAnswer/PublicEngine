...
/*
 *	engine/core/ManagedObject.h generated by Engine3 IDL compiler 0.51
 */
...
class ManagedObject : public RWLockable {
public:
	ManagedObject();
	ManagedObject(ORBObjectServant* obj);
...
class ManagedObjectAdapter : public RWLockableAdapter {
public:
...
class ManagedObjectHelper : public ORBClassHelper, public Singleton<ManagedObjectHelper> {
public:
	ManagedObjectHelper();
...
#include "thread/RWLockableImplementation.h"

class ManagedObjectServant : public RWLockableImplementation {
public:
	ManagedObject* _this;
